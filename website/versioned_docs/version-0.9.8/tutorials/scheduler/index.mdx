...
<LinkButtons
  githubUrl="https://github.com/cristianlara/ax/blob/main/tutorials/scheduler/scheduler.ipynb"
  colabUrl="https://colab.research.google.com/github/cristianlara/ax/blob/main/tutorials/scheduler/scheduler.ipynb"
/>
...
<PlotlyFigure data={require('./assets/plot_data/356e1c70-b8e3-451d-81b6-3143f127f9b0.json')} />
...
<PlotlyFigure data={require('./assets/plot_data/20cb42d3-eb40-4d30-bad6-6f5d668f7f31.json')} />
...
<PlotlyFigure data={require('./assets/plot_data/3288cc9f-ffbe-4255-be1c-506348175d16.json')} />
