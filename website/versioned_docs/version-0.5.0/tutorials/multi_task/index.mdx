...
<LinkButtons
  githubUrl="https://github.com/facebook/ax/blob/main/tutorials/multi_task/multi_task.ipynb"
  colabUrl="https://colab.research.google.com/github/facebook/ax/blob/main/tutorials/multi_task/multi_task.ipynb"
/>
