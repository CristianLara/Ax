...
<LinkButtons
  githubUrl="https://github.com/facebook/ax/blob/main/tutorials/scheduler/scheduler.ipynb"
  colabUrl="https://colab.research.google.com/github/facebook/ax/blob/main/tutorials/scheduler/scheduler.ipynb"
/>
