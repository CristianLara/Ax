...
<PlotlyFigure data={require('./assets/plot_data/2e47e8b5-10d9-40a4-b086-20d3a1e17253.json')} />

```python
render(plot_contour(model=model, param_x="x1", param_y="x2", metric_name="l2norm"))
```

<PlotlyFigure data={require('./assets/plot_data/8668504b-065e-49a2-a7e7-490a479db039.json')} />
...
<PlotlyFigure data={require('./assets/plot_data/4f4380c6-32ea-462e-8e41-a1f92320c252.json')} />
